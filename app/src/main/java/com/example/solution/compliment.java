...
public class compliment extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if(isRecording) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        audioRecordImageBtn.setImageDrawable(getResources().getDrawable(R.drawable.voice, null)); // 녹음 상태 아이콘 변경
                    }
                    audioRecordText.setText("칭찬 녹음 시작"); // 녹음 상태 텍스트 변경
                    stopRecording();
                    ...
                    if(checkAudioPermission()) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            audioRecordImageBtn.setImageDrawable(getResources().getDrawable(R.drawable.voice_stop, null)); // 녹음 상태 아이콘 변경
                        }
    ...
    private void startRecording() {
        ...
        audioFileName = recordPath + "/" +"칭찬음성" + timeStamp + "_"+"audio.mp4";
    ...
    private void playAudio(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            playIcon.setImageDrawable(getResources().getDrawable(R.drawable.play, null));
        }
        isPlaying = true;
    ...
    private void stopAudio() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            playIcon.setImageDrawable(getResources().getDrawable(R.drawable.play_stop, null));
        }
        isPlaying = false;
        mediaPlayer.stop();
    }
